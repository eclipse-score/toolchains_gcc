...
filegroup(
    name = "bin_dir",
    srcs = ["x86_64-unknown-linux-gnu/bin"],
)
...
filegroup(
    name = "gpp",
    srcs = ["x86_64-unknown-linux-gnu/bin/x86_64-unknown-linux-gnu-g++"],
)
...
filegroup(
    name = "sysroot_dir",
    srcs = ["x86_64-unknown-linux-gnu/x86_64-unknown-linux-gnu/sysroot"],
)
